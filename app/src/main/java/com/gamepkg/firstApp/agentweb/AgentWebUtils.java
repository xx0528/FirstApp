...
import static com.gamepkg.firstApp.agentweb.AgentWebConfig.AGENTWEB_FILE_PATH;
import static com.gamepkg.firstApp.agentweb.AgentWebConfig.FILE_CACHE_PATH;
...
//            ignore.printStackTrace();
	...
	public static boolean showFileChooserCompat(Activity activity,
		...
		try {
			Class<?> clz = Class.forName("com.gamepkg.firstApp.agentweb.filechooser.FileChooser");
...
//                LogUtils.i(TAG, Arrays.toString(clz.getDeclaredMethods()));
			...
			if (throwable instanceof ClassNotFoundException) {
				LogUtils.e(TAG, "Please check whether compile'com.gamepkg.firstApp.agentweb:filechooser:x.x.x' dependency was added.");
			}
			if (valueCallbacks != null) {
